...
func (args *TransactionArgs) ToMessage(globalGasCap uint64, baseFee *big.Int) (core.Message, error) {
	...
	msg := core.Message{From: addr, To: args.To, Nonce: nonce, Value: value, GasLimit: gas, GasPrice: gasPrice, GasFeeCap: gasFeeCap, GasTipCap: gasTipCap, Data: data, AccessList: accessList, SkipAccountChecks: true}
	return msg, nil
}
