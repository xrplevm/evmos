...
var (
	...
	ibcBase           = "ibc/ED07A3391A112B175915CD8FAF43A2DA8E4790EDE12566649D0C2F97716B8518"
)
...
func (s *PrecompileTestSuite) NewTestChainWithValSet(coord *ibctesting.Coordinator, valSet *tmtypes.ValidatorSet, signers map[string]tmtypes.PrivValidator) *ibctesting.TestChain {
	...
	precompile, err := osmosis.NewPrecompile(s.app.TransferKeeper, s.app.AuthzKeeper, s.app.BankKeeper, s.app.Erc20Keeper, s.app.IBCKeeper.ChannelKeeper)
	s.Require().NoError(err)
